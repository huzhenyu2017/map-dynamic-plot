/**
 * @class L.Draw.Double_Arrow
 * @aka Draw.Double_Arrow
 * @inherits L.Draw.Plot
 */
L.Draw.Double_Arrow = L.Draw.Plot.extend({
	statics: {
		TYPE: 'double_arrow'
	},
	...
	initialize: function (map, options) {
		...
		this.type = L.Draw.Double_Arrow.TYPE;
	...
	setCoordinates: function (LatLngs){
		...
		if(poly.connPoint!=null)
        poly.points.push(L.latLng(poly.connPoint));
	},	
});
