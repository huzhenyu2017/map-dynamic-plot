...
L.Control.BrowserPrint.Utils = {
	...
	cloneLayer: function(layer) {
		...
		// Renderers
		if (L.MigrationLayer && layer instanceof L.MigrationLayer) {
		   return L.migrationLayer(options,layer._latlngs);
		}
   ...
   getType: function(layer) {
   	   ...
   	   if (L.MigrationLayer && layer instanceof L.MigrationLayer) { return "L.MigrationLayer"; } // Renderer
